  ...
  return <div className="py-16 px-4">
      <div className="max-w-2xl mx-auto space-y-12">
        ...
        <AnimatedSection>
          ...
          <p className="text-muted-foreground leading-relaxed">When you place an order, it goes directly to the store you ordered from. Then someone from the store contacts you for payment and delivery details.</p>
        </AnimatedSection>
        ...
        <AnimatedSection>
          ...
          <div className="flex-wrap pt-2 flex-col flex items-start justify-center gap-[8px]">
